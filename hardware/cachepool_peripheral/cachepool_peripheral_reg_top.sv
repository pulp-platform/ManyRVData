...
module cachepool_peripheral_reg_top #(
  ...
  logic [31:0] hw_barrier_participation_mask_qs;
  logic [31:0] hw_barrier_participation_mask_wd;
  ...
  always_comb begin
    ...
    addr_hit[12] = (reg_addr == CACHEPOOL_PERIPHERAL_HW_BARRIER_PARTICIPATION_MASK_OFFSET);
  ...
  assign hw_barrier_participation_mask_we = addr_hit[12] & reg_we & !reg_error;
  assign hw_barrier_participation_mask_wd = reg_wdata[31:0];
  ...
  always_comb begin
    ...
    unique case (1'b1)
      ...
      addr_hit[12]: begin
        reg_rdata_next[31:0] = hw_barrier_participation_mask_qs;
      end
