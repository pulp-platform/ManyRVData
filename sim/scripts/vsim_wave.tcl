...
for {set g 0} {$g < $NUM_GROUPS} {incr g} {
    ...
    for {set tile 0} {$tile < $NUM_TILES} {incr tile} {
        ...
        quietly set ch 0
        while {[llength [find instances -nodu ${group_wp_path}/gen_noc/gen_req_router_t[${tile}]/gen_req_router_n[${ch}]/i_req_router]] > 0} {
            add wave -noupdate -group "${gwp_name}" -group L1NoC -group ReqRouter -group tile[${tile}] -group ch[${ch}] ${group_wp_path}/gen_noc/gen_req_router_t[${tile}]/gen_req_router_n[${ch}]/i_req_router/*
