...
// Number of independent hardware barrier round trackers (must match
// hardware/src/cachepool_pkg.sv NumBarrierSlots).
#define CACHEPOOL_PERIPHERAL_PARAM_NUM_BARRIER_SLOTS 2
...
// Spatz ownership acquire for dual-Snitch core complexes. Load
#define CACHEPOOL_PERIPHERAL_SPATZ_LOCK_ACQUIRE_REG_OFFSET 0x4

// Spatz ownership release for dual-Snitch core complexes. Load
#define CACHEPOOL_PERIPHERAL_SPATZ_LOCK_RELEASE_REG_OFFSET 0x8

// Controls prefetching of the instruction cache.
#define CACHEPOOL_PERIPHERAL_ICACHE_PREFETCH_ENABLE_REG_OFFSET 0xc
#define CACHEPOOL_PERIPHERAL_ICACHE_PREFETCH_ENABLE_ICACHE_PREFETCH_ENABLE_BIT 0

// Sets the status of the Spatz cluster.
#define CACHEPOOL_PERIPHERAL_SPATZ_STATUS_REG_OFFSET 0x10
#define CACHEPOOL_PERIPHERAL_SPATZ_STATUS_SPATZ_CLUSTER_PROBE_BIT 0

// Store cycle counts of kernels
#define CACHEPOOL_PERIPHERAL_SPATZ_CYCLE_REG_OFFSET 0x14

// Controls the cluster boot process.
#define CACHEPOOL_PERIPHERAL_CLUSTER_BOOT_CONTROL_REG_OFFSET 0x18

// End of computation and exit status register
#define CACHEPOOL_PERIPHERAL_CLUSTER_EOC_EXIT_REG_OFFSET 0x1c
...
#define CACHEPOOL_PERIPHERAL_CFG_L1D_SPM_REG_OFFSET 0x20
...
#define CACHEPOOL_PERIPHERAL_CFG_L1D_INSN_REG_OFFSET 0x24
...
// One-hot tile selection mask for private-partition flush.
#define CACHEPOOL_PERIPHERAL_CFG_L1D_TILE_SEL_0_REG_OFFSET 0x28

// One-hot tile selection mask for private-partition flush.
#define CACHEPOOL_PERIPHERAL_CFG_L1D_TILE_SEL_1_REG_OFFSET 0x2c

// Per-slot group participation mask for the cluster-level hardware
#define CACHEPOOL_PERIPHERAL_HW_BARRIER_PARTICIPATION_MASK_GROUP_FIELD_WIDTH 32
#define CACHEPOOL_PERIPHERAL_HW_BARRIER_PARTICIPATION_MASK_GROUP_FIELDS_PER_REG \
  1
#define CACHEPOOL_PERIPHERAL_HW_BARRIER_PARTICIPATION_MASK_MULTIREG_COUNT 2

// Per-slot group participation mask for the cluster-level hardware
#define CACHEPOOL_PERIPHERAL_HW_BARRIER_PARTICIPATION_MASK_0_REG_OFFSET 0x30

// Per-slot group participation mask for the cluster-level hardware
#define CACHEPOOL_PERIPHERAL_HW_BARRIER_PARTICIPATION_MASK_1_REG_OFFSET 0x34

// Controls the L1 DCache flushing and invalidation.
#define CACHEPOOL_PERIPHERAL_L1D_SPM_COMMIT_REG_OFFSET 0x38
#define CACHEPOOL_PERIPHERAL_L1D_SPM_COMMIT_COMMIT_BIT 0

// Controls the L1 DCache flushing and invalidation.
#define CACHEPOOL_PERIPHERAL_L1D_INSN_COMMIT_REG_OFFSET 0x3c
...
#define CACHEPOOL_PERIPHERAL_XBAR_OFFSET_REG_OFFSET 0x4c
...
// Cache xbar offset setting
#define CACHEPOOL_PERIPHERAL_XBAR_OFFSET_COMMIT_REG_OFFSET 0x50
