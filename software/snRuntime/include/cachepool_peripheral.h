...
// Spatz ownership lock for dual-Snitch core complexes. Write 1 to acquire
#define CACHEPOOL_PERIPHERAL_SPATZ_LOCK_REG_OFFSET 0x4

// Controls prefetching of the instruction cache.
#define CACHEPOOL_PERIPHERAL_ICACHE_PREFETCH_ENABLE_REG_OFFSET 0x8
#define CACHEPOOL_PERIPHERAL_ICACHE_PREFETCH_ENABLE_ICACHE_PREFETCH_ENABLE_BIT 0

// Sets the status of the Spatz cluster.
#define CACHEPOOL_PERIPHERAL_SPATZ_STATUS_REG_OFFSET 0xc
#define CACHEPOOL_PERIPHERAL_SPATZ_STATUS_SPATZ_CLUSTER_PROBE_BIT 0

// Store cycle counts of kernels
#define CACHEPOOL_PERIPHERAL_SPATZ_CYCLE_REG_OFFSET 0x10

// Controls the cluster boot process.
#define CACHEPOOL_PERIPHERAL_CLUSTER_BOOT_CONTROL_REG_OFFSET 0x14

// End of computation and exit status register
#define CACHEPOOL_PERIPHERAL_CLUSTER_EOC_EXIT_REG_OFFSET 0x18
...
#define CACHEPOOL_PERIPHERAL_CFG_L1D_SPM_REG_OFFSET 0x1c
...
#define CACHEPOOL_PERIPHERAL_CFG_L1D_INSN_REG_OFFSET 0x20
...
// One-hot tile selection mask for private-partition flush.
#define CACHEPOOL_PERIPHERAL_CFG_L1D_TILE_SEL_0_REG_OFFSET 0x24

// One-hot tile selection mask for private-partition flush.
#define CACHEPOOL_PERIPHERAL_CFG_L1D_TILE_SEL_1_REG_OFFSET 0x28
...
// Tile participation mask for the cluster-level hardware barrier.
#define CACHEPOOL_PERIPHERAL_HW_BARRIER_PARTICIPATION_MASK_0_REG_OFFSET 0x2c

// Tile participation mask for the cluster-level hardware barrier.
#define CACHEPOOL_PERIPHERAL_HW_BARRIER_PARTICIPATION_MASK_1_REG_OFFSET 0x30
