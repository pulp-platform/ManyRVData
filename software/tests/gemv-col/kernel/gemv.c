...
void __attribute__((noinline)) gemv_v64b_m4_unroll_M(double *a, double* b, double* c, int M, int M_core, int N) {
  unsigned int vl, avl = M_core;
  double *a_      = a;
  double *a_nextM = a_ + (M_core * N);
  double *b_ = b;
  double *c_ = c;
  ...
  do {
    ...
    for (int col=0; col < N; col+=2) {
      ...
      a_ += M;
      asm volatile("vle64.v v16, (%0)" ::"r"(a_nextM));
      a_nextM += M;
      ...
      a_ += M;
      asm volatile("vle64.v v24, (%0)" ::"r"(a_nextM));
      a_nextM += M;
...
void __attribute__((noinline)) gemv_v64b_m4(double *a, double* b, double* c, int M, int M_core, int N) {
  unsigned int vl, avl = M_core;
  double *a_ = a;
  double *b_ = b;
  double *c_ = c;
